...
exports.FB_URL   = 'https://sozialdata.firebaseio.com';https:
...
exports.FB_SERVICEACCOUNT = "SozialData-15ee462e5235.json";
...
exports.paths = [
   ...
   },
   {
      ...
      index: "firebase",
      type:  "institution",
      fields: ["description", "institution", "mail", "phone", "shortDiscription", "address", "tags", "website", "source"],
      filter: function(data) { return data.name !== 'system'; }
   }
];
